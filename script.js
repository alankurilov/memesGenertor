...
function clearAll() {
  const DivMeme = document.querySelector("#memes")
  DivMeme.innerHTML = "";
  const DivJoke = document.querySelector("#joke")
  DivJoke.innerHTML = "";
  const DivQuote = document.querySelector("#randomQuote")
  DivQuote.innerHTML = ""
 ...
 */
const btnM = document.querySelector("#memesButton")
function btnMeme() {
  ...
  DivMeme.appendChild(meme)
  console.log(randomMemeUrl)
}
btnM.onclick = btnMeme
...
function showJoke() {
  ...
  const DivJoke = document.querySelector("#joke")
  DivJoke.innerHTML = randomJokeText
}
btnJoke.onclick = showJoke
 ...
 */
const btnQuote = document.querySelector("#quoteButton")
function showQuote() {
  ...
  DivQuote.innerHTML =`Quote: ${randomQuote.quote} 
  Author: ${randomQuote.author}`  

}
btnQuote.onclick = showQuote
 ...
 */
const btnRiddle = document.querySelector("#riddleButton")
...
function showRiddle() {
  ...
  DivRiddle.innerHTML = `question: ${randomRiddle.question}
  ...
  DivRiddle.appendChild(answerButton)

}
btnRiddle.onclick = showRiddle
